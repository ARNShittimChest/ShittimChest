...
- Install via CLI: `shittimchest plugins install @shittimchest/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `shittimchest plugins install ./extensions/zalo`
   - From npm (if published): `shittimchest plugins install @shittimchest/zalo`
...
- Approve via:
  - `shittimchest pairing list zalo`
  - `shittimchest pairing approve zalo <CODE>`
...
- Example: `shittimchest message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `shittimchest channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `shittimchest logs --follow`
