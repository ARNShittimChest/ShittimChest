...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure ShittimChest HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `shittimchest pairing approve slack <code>`.
...
```bash
shittimchest pairing list slack
```
...
ShittimChest supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, ShittimChest falls back to normal delivery for remaining payloads.
