---
summary: "Synology Chat webhook setup and ShittimChest config"
read_when:
  - Setting up Synology Chat with ShittimChest
...
```bash
shittimchest plugins install ./extensions/synology-chat
```
...
3. Point the outgoing webhook URL to your ShittimChest gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in ShittimChest.
...
- Pairing approvals work with:
  - `shittimchest pairing list synology-chat`
  - `shittimchest pairing approve synology-chat <CODE>`
...
```bash
shittimchest message send --channel synology-chat --target 123456 --text "Hello from ShittimChest"
shittimchest message send --channel synology-chat --target synology-chat:123456 --text "Hello again"
```
