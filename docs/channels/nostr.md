...
read_when:
  - You want ShittimChest to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables ShittimChest to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`shittimchest onboard`) and `shittimchest channels add` list optional channel plugins.
...
```bash
shittimchest plugins install @shittimchest/nostr
```

Use a local checkout (dev workflows):

```bash
shittimchest plugins install --link <path-to-shittimchest>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "shittimchest",
        "displayName": "ShittimChest",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "shittimchest@example.com",
        "lud16": "shittimchest@example.com"
      }
    }
  }
}
