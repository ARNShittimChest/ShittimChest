...
ShittimChest integrates external CLIs via JSON-RPC. Two patterns are used today.
...
- ShittimChest owns lifecycle when `channels.signal.autoStart=true`.
...
- ShittimChest spawns `imsg rpc` as a child process (legacy iMessage integration).
