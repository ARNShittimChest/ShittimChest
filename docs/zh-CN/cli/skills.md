...
summary: "`shittimchest skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
shittimchest skills list
shittimchest skills list --eligible
shittimchest skills info <name>
shittimchest skills check
```
