...
本指南总结了在 ShittimChest 中开发 Pi 集成的合理工作流程。
...
状态存储在 ShittimChest 状态目录下。默认为 `~/.shittimchest`。如果设置了 `SHITTIMCHEST_STATE_DIR`，则使用该目录。

要重置所有内容：

- `shittimchest.json` 用于配置
...
- https://docs.shittimchest.ai/testing
- https://docs.shittimchest.ai/start/getting-started
