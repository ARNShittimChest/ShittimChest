...
- 生成的 Swift 模型：`apps/macos/Sources/ShittimChestProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/shittimchest/shittimchest/main/dist/protocol.schema.json
