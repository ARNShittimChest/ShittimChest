---
summary: "Use Synthetic's Anthropic-compatible API in ShittimChest"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ShittimChest registers it as the
...
Note: ShittimChest's Anthropic client appends `/v1` to the base URL, so use
