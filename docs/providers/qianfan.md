---
summary: "Use Qianfan's unified API to access many models in ShittimChest"
read_when:
...
3. ShittimChest installed on your system
...
4. Copy the API key for use with ShittimChest

## CLI setup

```bash
shittimchest onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ShittimChest Configuration](/gateway/configuration)
