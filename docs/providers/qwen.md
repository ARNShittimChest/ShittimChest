---
summary: "Use Qwen OAuth (free tier) in ShittimChest"
read_when:
  - You want to use Qwen with ShittimChest
...
If you already logged in with the Qwen Code CLI, ShittimChest will sync credentials
