---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ShittimChest"
read_when:
  - You want Xiaomi MiMo models in ShittimChest
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ShittimChest uses
