...
You can point ShittimChest at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ShittimChest
...
- [Anthropic provider](/providers/anthropic) - Native ShittimChest integration with Claude setup-token or API keys
