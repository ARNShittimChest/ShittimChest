---
summary: "Use NVIDIA's OpenAI-compatible API in ShittimChest"
read_when:
  - You want to use NVIDIA models in ShittimChest
...
shittimchest onboard --auth-choice skip
shittimchest models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
