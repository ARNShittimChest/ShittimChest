---
summary: "CLI reference for `shittimchest onboard` (interactive onboarding wizard)"
read_when:
...
```bash
shittimchest onboard
shittimchest onboard --flow quickstart
shittimchest onboard --flow manual
shittimchest onboard --mode remote --remote-url ws://gateway-host:18789
```
...
- Fastest first chat: `shittimchest dashboard` (Control UI, no channel setup).
