---
summary: "Overview of ShittimChest onboarding options and flows"
read_when:
...
ShittimChest supports multiple onboarding paths depending on where the Gateway runs
...
- [`shittimchest onboard` command](/cli/onboard)

## macOS app onboarding

Use the ShittimChest app when you want a fully guided setup on macOS. Docs:
