---
summary: "Hubs that link to every ShittimChest doc"
read_when:
...
<Note>
If you are new to ShittimChest, start with [Getting Started](/start/getting-started).
</Note>
...
- [ShittimChest assistant](/start/shittimchest)
