...
read_when:
  - You are building a ShittimChest plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (shittimchest.plugin.json)

Every plugin **must** ship a `shittimchest.plugin.json` file in the **plugin root**.
ShittimChest uses this manifest to validate configuration **without executing plugin
