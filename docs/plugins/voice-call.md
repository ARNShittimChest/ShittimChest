...
read_when:
  - You want to place an outbound voice call from ShittimChest
...
Voice calls for ShittimChest via a plugin. Supports outbound notifications and
...
- Use `shittimchest voicecall ...` or the `voice_call` tool
...
```bash
shittimchest plugins install ./extensions/voice-call
