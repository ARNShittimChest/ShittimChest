...
Deploy ShittimChest on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/shittimchest` — Control UI
...
- `SHITTIMCHEST_STATE_DIR=/data/.shittimchest` (recommended)
- `SHITTIMCHEST_WORKSPACE_DIR=/data/workspace` (recommended)
- `SHITTIMCHEST_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your ShittimChest state + workspace so you can migrate to another host without losing config or memory.
