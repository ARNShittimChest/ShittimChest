...
ShittimChest ships three update channels:
...
When you **explicitly** switch channels with `--channel`, ShittimChest also aligns
the install method:
...
When you switch channels with `shittimchest update`, ShittimChest also syncs plugin sources:
