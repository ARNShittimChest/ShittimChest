...
ShittimChest treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.shittimchest/settings/voicewake.json`

Shape:

```json
{ "triggers": ["shittimchest", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
