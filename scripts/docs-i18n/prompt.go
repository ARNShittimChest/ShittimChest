...
- Keep product names in English: ShittimChest, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the ShittimChest Gateway, use “Gateway 网关”.
