...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "shittimchest", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for ShittimChest. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("ShittimChest Issue Label Audit");
