...
on_error() {
  ...
  echo "If this persists, verify dependencies and try again." >&2
}
trap on_error ERR
...
A2UI_APP_DIR="$ROOT_DIR/apps/shared/ShittimChestKit/Tools/CanvasA2UI"
