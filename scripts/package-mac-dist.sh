...
#
# Output:
# - dist/ShittimChest.app
# - dist/ShittimChest-<version>.zip
# - dist/ShittimChest-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.shittimchest.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/ShittimChest.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ShittimChest-$VERSION.zip"
DMG="$ROOT_DIR/dist/ShittimChest-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ShittimChest-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ShittimChest-$VERSION.dSYM.zip"
