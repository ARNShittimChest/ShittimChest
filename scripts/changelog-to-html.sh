...
if [[ -z "$version_content" ]]; then
  echo "<h2>ShittimChest $VERSION</h2>"
  echo "<p>Latest ShittimChest update.</p>"
  echo "<p><a href=\"https://github.com/shittimchest/shittimchest/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
