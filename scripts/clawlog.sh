...
show_usage() {
    cat << EOF
clawlog - ShittimChest Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ShittimChest logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ShittimChest logs flow through the macOS unified log (subsystem: ai.shittimchest).
