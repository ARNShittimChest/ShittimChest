...
function setMSTeamsDmPolicy(cfg: ShittimChestConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: ShittimChestConfig, allowFrom: string[]): ShittimChestConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
