...
function listConfiguredAccountIds(cfg: ShittimChestConfig): string[] {
...
export function listZaloAccountIds(cfg: ShittimChestConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: ShittimChestConfig): string {
...
function mergeZaloAccountConfig(cfg: ShittimChestConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: ShittimChestConfig): ResolvedZaloAccount[] {
