...
export function listZalouserAccountIds(cfg: ShittimChestConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ShittimChestConfig): string {
...
function mergeZalouserAccountConfig(cfg: ShittimChestConfig, accountId: string): ZalouserAccountConfig {
