...
import { withTempDownloadPath, type ClawdbotConfig } from "shittimchest/plugin-sdk";
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "shittimchest-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "shittimchest-feishu-resource-",
