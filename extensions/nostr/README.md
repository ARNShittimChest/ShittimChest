...
Nostr DM channel plugin for ShittimChest using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ShittimChest. It enables your bot to:
...
# Configure shittimchest to use local relay
