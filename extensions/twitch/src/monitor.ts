...
import type { ReplyPayload, ShittimChestConfig } from "shittimchest/plugin-sdk";
import { createReplyPrefixOptions } from "shittimchest/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // ShittimChestConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ShittimChestConfig;
