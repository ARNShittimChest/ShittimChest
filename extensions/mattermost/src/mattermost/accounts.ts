...
export function listMattermostAccountIds(cfg: ShittimChestConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ShittimChestConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ShittimChestConfig): ResolvedMattermostAccount[] {
