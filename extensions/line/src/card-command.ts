import type { LineChannelData, ShittimChestPluginApi, ReplyPayload } from "shittimchest/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: ShittimChestPluginApi): void {
  api.registerCommand({
    name: "card",
