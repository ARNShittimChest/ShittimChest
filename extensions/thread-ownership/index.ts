import type { ShittimChestConfig, ShittimChestPluginApi } from "shittimchest/plugin-sdk";
...
function resolveOwnershipAgent(config: ShittimChestConfig): { id: string; name: string } {
