...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "shittimchest/plugin-sdk";
import {
  ACPX_PINNED_VERSION,
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: ShittimChestPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: ShittimChestPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
