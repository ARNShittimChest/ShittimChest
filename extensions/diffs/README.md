...
Read-only diff viewer plugin for **ShittimChest** agents.
...
Set plugin-wide defaults in `~/.shittimchest/shittimchest.json`:
...
Before:
ShittimChest supports plugins.

After:
ShittimChest supports plugins and hosted diff views.
```
