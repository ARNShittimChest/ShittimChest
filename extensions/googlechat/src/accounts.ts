...
export function listGoogleChatAccountIds(cfg: ShittimChestConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ShittimChestConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ShittimChestConfig): ResolvedGoogleChatAccount[] {
