...
import { resolveChannelMediaMaxBytes, type ShittimChestConfig } from "shittimchest/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: ShittimChestConfig; accountId?: string }): string[] {
