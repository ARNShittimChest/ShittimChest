...
This directory contains the **BlueBubbles external channel plugin** for ShittimChest.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `shittimchest/plugin-sdk` helpers.
