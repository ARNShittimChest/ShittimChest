...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.shittimchest.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to ShittimChest", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to ShittimChest gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to ShittimChest.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "ShittimChestShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "ShittimChest is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "ShittimChest Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("shittimchest-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
