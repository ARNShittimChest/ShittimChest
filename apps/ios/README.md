# ShittimChest iOS (Super Alpha)

NO TEST FLIGHT AVAILABLE AT THIS POINT

This iPhone app is super-alpha and internal-use only. It connects to an ShittimChest Gateway as a `role: node`.
...
- `apps/ios/Sources/ShittimChest.entitlements` sets `aps-environment` to `development`.
