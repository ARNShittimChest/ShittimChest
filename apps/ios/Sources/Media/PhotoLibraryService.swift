...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ShittimChestPhotosLatestParams) async throws -> ShittimChestPhotosLatestPayload {
        ...
        var results: [ShittimChestPhotoPayload] = []
        ...
        return ShittimChestPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ShittimChestPhotoPayload
    {
        ...
        return ShittimChestPhotoPayload(
            format: "jpeg",
