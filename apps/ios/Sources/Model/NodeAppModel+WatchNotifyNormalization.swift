...
extension NodeAppModel {
    static func normalizeWatchNotifyParams(_ params: ShittimChestWatchNotifyParams) -> ShittimChestWatchNotifyParams {
    ...
    static func normalizeWatchActions(
        _ actions: [ShittimChestWatchAction]?,
        kind: String?,
        promptId: String?) -> [ShittimChestWatchAction]
    {
        let provided = (actions ?? []).compactMap { action -> ShittimChestWatchAction? in
            let id = action.id.trimmingCharacters(in: .whitespacesAndNewlines)
            let label = action.label.trimmingCharacters(in: .whitespacesAndNewlines)
            guard !id.isEmpty, !label.isEmpty else { return nil }
            return ShittimChestWatchAction(
                id: id,
                label: label,
        ...
        if normalizedKind.contains("approval") || normalizedKind.contains("approve") {
            return [
                ShittimChestWatchAction(id: "approve", label: "Approve"),
                ShittimChestWatchAction(id: "decline", label: "Decline", style: "destructive"),
                ShittimChestWatchAction(id: "open_phone", label: "Open iPhone"),
                ShittimChestWatchAction(id: "escalate", label: "Escalate"),
            ]
        }

        return [
            ShittimChestWatchAction(id: "done", label: "Done"),
            ShittimChestWatchAction(id: "snooze_10m", label: "Snooze 10m"),
            ShittimChestWatchAction(id: "open_phone", label: "Open iPhone"),
            ShittimChestWatchAction(id: "escalate", label: "Escalate"),
        ]
    }
    ...
    static func normalizedWatchRisk(
        _ risk: ShittimChestWatchRisk?,
        priority: ShittimChestNotificationPriority?) -> ShittimChestWatchRisk?
    {
    ...
    static func normalizedWatchPriority(
        _ priority: ShittimChestNotificationPriority?,
        risk: ShittimChestWatchRisk?) -> ShittimChestNotificationPriority?
    {
