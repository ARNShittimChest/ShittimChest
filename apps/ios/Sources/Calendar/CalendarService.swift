...
final class CalendarService: CalendarServicing {
    func events(params: ShittimChestCalendarEventsParams) async throws -> ShittimChestCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            ShittimChestCalendarEventPayload(
        ...
        return ShittimChestCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: ShittimChestCalendarAddParams) async throws -> ShittimChestCalendarAddPayload {
        ...
        let payload = ShittimChestCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return ShittimChestCalendarAddPayload(event: payload)
    }
