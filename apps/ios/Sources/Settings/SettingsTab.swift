...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ShittimChestLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = ShittimChestLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.shittimchest.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected ShittimChest agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while ShittimChest is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for ShittimChest. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(ShittimChestLocationMode.off.rawValue)
                            Text("While Using").tag(ShittimChestLocationMode.whileUsing.rawValue)
                            Text("Always").tag(ShittimChestLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while ShittimChest is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("ShittimChest", value: DeviceInfoHelper.shittimChestVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = ShittimChestLocationMode(rawValue: newValue) else { return }
                Task {
