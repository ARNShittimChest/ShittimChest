...
actor CameraController {
    ...
    func snap(params: ShittimChestCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: ShittimChestCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("shittimchest-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("shittimchest-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: ShittimChestCameraFacing,
