...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [ShittimChestCapability.canvas.rawValue, ShittimChestCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(ShittimChestCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(ShittimChestCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = ShittimChestLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(ShittimChestCapability.location.rawValue) }

        caps.append(ShittimChestCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(ShittimChestCapability.watch.rawValue)
        }
        caps.append(ShittimChestCapability.photos.rawValue)
        caps.append(ShittimChestCapability.contacts.rawValue)
        caps.append(ShittimChestCapability.calendar.rawValue)
        caps.append(ShittimChestCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(ShittimChestCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            ShittimChestScreenCommand.record.rawValue,
            ShittimChestSystemCommand.notify.rawValue,
            ShittimChestChatCommand.push.rawValue,
        ...
        if caps.contains(ShittimChestCapability.camera.rawValue) {
            commands.append(ShittimChestCameraCommand.list.rawValue)
            commands.append(ShittimChestCameraCommand.snap.rawValue)
            commands.append(ShittimChestCameraCommand.clip.rawValue)
        }
        if caps.contains(ShittimChestCapability.location.rawValue) {
            commands.append(ShittimChestLocationCommand.get.rawValue)
        }
        if caps.contains(ShittimChestCapability.device.rawValue) {
            commands.append(ShittimChestDeviceCommand.status.rawValue)
            commands.append(ShittimChestDeviceCommand.info.rawValue)
        }
        if caps.contains(ShittimChestCapability.watch.rawValue) {
            commands.append(ShittimChestWatchCommand.status.rawValue)
            commands.append(ShittimChestWatchCommand.notify.rawValue)
        }
        if caps.contains(ShittimChestCapability.photos.rawValue) {
            commands.append(ShittimChestPhotosCommand.latest.rawValue)
        }
        if caps.contains(ShittimChestCapability.contacts.rawValue) {
            commands.append(ShittimChestContactsCommand.search.rawValue)
            commands.append(ShittimChestContactsCommand.add.rawValue)
        }
        if caps.contains(ShittimChestCapability.calendar.rawValue) {
            commands.append(ShittimChestCalendarCommand.events.rawValue)
            commands.append(ShittimChestCalendarCommand.add.rawValue)
        }
        if caps.contains(ShittimChestCapability.reminders.rawValue) {
            commands.append(ShittimChestRemindersCommand.list.rawValue)
            commands.append(ShittimChestRemindersCommand.add.rawValue)
        }
        if caps.contains(ShittimChestCapability.motion.rawValue) {
            commands.append(ShittimChestMotionCommand.activity.rawValue)
            commands.append(ShittimChestMotionCommand.pedometer.rawValue)
        }
