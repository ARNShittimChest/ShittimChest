...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.shittimchest.gateway"
    private static let nodeService = "ai.shittimchest.node"
    private static let talkService = "ai.shittimchest.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.shittimchest.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.shittimchest.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("shittimchest-gateway.log")
    }
