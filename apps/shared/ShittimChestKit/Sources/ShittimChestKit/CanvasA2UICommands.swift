...
public enum ShittimChestCanvasA2UICommand: String, Codable, Sendable {
...
public struct ShittimChestCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ShittimChestCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
