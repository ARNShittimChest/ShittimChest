...
@MainActor
public struct ShittimChestChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: ShittimChestChatViewModel
    ...
    public init(
        viewModel: ShittimChestChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                ShittimChestChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [ShittimChestChatMessage] {
        let base: [ShittimChestChatMessage]
    ...
    private func mergeToolResults(in messages: [ShittimChestChatMessage]) -> [ShittimChestChatMessage] {
        ...
        for message in messages {
            ...
            let merged = ShittimChestChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: ShittimChestChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: ShittimChestChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: ShittimChestChatMessage) -> String {
