...
@Suite struct InstancesStoreTests {
    ...
    func presenceEventPayloadDecodesViaJSONEncoder() {
        ...
        let entry: [String: ShittimChestProtocol.AnyCodable] = [
            "host": .init("gw"),
            "ip": .init("10.0.0.1"),
            "version": .init("2.0.0"),
            "mode": .init("gateway"),
        ...
        let payloadMap: [String: ShittimChestProtocol.AnyCodable] = [
            "presence": .init([ShittimChestProtocol.AnyCodable(entry)]),
        ]
        let payload = ShittimChestProtocol.AnyCodable(payloadMap)
