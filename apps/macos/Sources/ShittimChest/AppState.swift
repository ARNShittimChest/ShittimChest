...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ShittimChestConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ShittimChestConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ShittimChestConfigFile.loadDict()
            ...
            ShittimChestConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/shittimchest"
        state.remoteCliPath = ""
        return state
    }
}
