...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .shittimchestSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ShittimChestPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ShittimChestPaths.stateDirURL.path
...
extension Notification.Name {
    static let shittimchestSelectSettingsTab = Notification.Name("shittimchestSelectSettingsTab")
}
