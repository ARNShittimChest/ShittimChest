...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: ShittimChestProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": ShittimChestProtocol.AnyCodable("start"),
                "name": ShittimChestProtocol.AnyCodable("bash"),
            ],
            summary: nil)
