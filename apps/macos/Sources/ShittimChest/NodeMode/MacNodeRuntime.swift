...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case ShittimChestLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case ShittimChestSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case ShittimChestSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case ShittimChestSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case ShittimChestSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case ShittimChestSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case ShittimChestCanvasA2UICommand.push.rawValue,
             ShittimChestCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__shittimchest__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ShittimChestSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(ShittimChestSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: ShittimChestSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> ShittimChestLocationMode {
    ...
    private static func errorResponse(
        ...
        code: ShittimChestNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: ShittimChestNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: ShittimChestCanvasSnapshotFormat,
        maxWidth: Int?,
