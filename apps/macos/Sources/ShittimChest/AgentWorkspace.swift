...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.shittimchest", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ShittimChestConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - ShittimChest Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.shittimchest/shittimchest.json
