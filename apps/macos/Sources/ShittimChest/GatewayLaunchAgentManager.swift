...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.shittimchest", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".shittimchest/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.shittimchestCommand(
            subcommand: "gateway",
