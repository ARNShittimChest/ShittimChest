...
enum ShittimChestConfigFile {
    private static let logger = Logger(subsystem: "ai.shittimchest", category: "config")
    ...
    static func stateDirURL() -> URL {
        ShittimChestPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ShittimChestPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-shittimchest-config-file",
            "event": "config.write",
