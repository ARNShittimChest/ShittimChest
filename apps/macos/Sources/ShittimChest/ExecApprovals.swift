...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.shittimchest", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ShittimChestPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ShittimChestPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
