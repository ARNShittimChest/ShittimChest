...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/shittimchest/shittimchest") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/shittimchest/shittimchest")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://shittimchest.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ShittimChestBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ShittimChestBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ShittimChestGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ShittimChestGitCommit") as? String) ??
            "unknown"
    }
