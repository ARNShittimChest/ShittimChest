...
enum UIStrings {
    static let welcomeTitle = "Welcome to ShittimChest"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "shittimchest.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: ShittimChestChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g shittimchest@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ShittimChestChatViewModel(
