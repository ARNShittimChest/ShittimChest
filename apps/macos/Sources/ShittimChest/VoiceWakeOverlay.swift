...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.shittimchest", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ShittimChest windows, but below the system’s pop-up menus.
