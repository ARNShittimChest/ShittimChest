...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.shittimchest", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.shittimchest", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ShittimChestChatMessage] = messages.compactMap { item in
