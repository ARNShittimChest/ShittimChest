...
import ai.shittimchest.android.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "ShittimChest",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("ShittimChest is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
