...
class SecurePrefs(context: Context) {
  companion object {
    val defaultWakeWords: List<String> = listOf("shittimchest", "claude")
    private const val displayNameKey = "node.displayName"
    private const val voiceWakeModeKey = "voiceWake.mode"
    private const val plainPrefsName = "shittimchest.node"
    private const val securePrefsName = "shittimchest.node.secure"
  }
