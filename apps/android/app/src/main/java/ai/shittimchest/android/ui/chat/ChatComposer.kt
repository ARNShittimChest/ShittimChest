...
import ai.shittimchest.android.ui.mobileSurface
import ai.shittimchest.android.ui.mobileText
import ai.shittimchest.android.ui.mobileTextSecondary
import ai.shittimchest.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.shittimchest.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.shittimchest.android.ui.mobileFontFamily,
