...
android {
  namespace = "ai.shittimchest.android"
  compileSdk = 36

  sourceSets {
    getByName("main") {
      assets.directories.add("../../shared/ShittimChestKit/Sources/ShittimChestKit/Resources")
    }
  }

  defaultConfig {
    applicationId = "ai.shittimchest.android"
    minSdk = 31
    targetSdk = 36
  ...
  onVariants { variant ->
    variant.outputs
      ...
      .forEach { output ->
        ...
        val outputFileName = "shittimchest-${versionName}-${buildType}.apk"
