...
export const A2UI_PATH = "/__shittimchest__/a2ui";

export const CANVAS_HOST_PATH = "/__shittimchest__/canvas";

export const CANVAS_WS_PATH = "/__shittimchest__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.shittimchestCanvasA2UIAction.postMessage(...)
  // - Android: window.shittimchestCanvasA2UIAction.postMessage(...)
  const handlerNames = ["shittimchestCanvasA2UIAction"];
  ...
  globalThis.ShittimChest = globalThis.ShittimChest ?? {};
  globalThis.ShittimChest.postMessage = postToNode;
  globalThis.ShittimChest.sendUserAction = sendUserAction;
  globalThis.shittimchestPostMessage = postToNode;
  globalThis.shittimchestSendUserAction = sendUserAction;
