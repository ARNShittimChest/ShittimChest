...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ShittimChestConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ShittimChestConfig; env: NodeJS.ProcessEnv }): {
  cfg: ShittimChestConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
