...
function mergeSlackAccountConfig(cfg: ShittimChestConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: ShittimChestConfig): ResolvedSlackAccount[] {
