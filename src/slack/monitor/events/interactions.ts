...
// Prefix for ShittimChest-generated action IDs to scope our handler
const SHITTIMCHEST_ACTION_PREFIX = "shittimchest:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${SHITTIMCHEST_ACTION_PREFIX}`);

  // Handle ShittimChest modal submissions with callback_ids scoped by our prefix.
