...
export function buildAgentSystemPrompt(params: {
  ...
  if (companionMoodContext && !isMinimal) {
    lines.push(
      ...
      "</arona_feelings>",
      "",
      "Các mood hợp lệ: happy, neutral, sad, excited, worried, caring, sleepy",
      "",
      "Hướng dẫn đánh giá:",
      ...
      "- affection_delta: Tương tác này ảnh hưởng mối quan hệ thế nào? Sensei khen → +2~+5. Chat bình thường → +1. Sensei thô lỗ → -3~-5. Sensei quan tâm Arona → +3~+6",
      ...
      '[worried] Sensei... đừng cố quá nha... <arona_feelings>{"arona_mood":"worried","arona_intensity":0.6,"sensei_mood":"sad","sensei_intensity":0.5,"affection_delta":1,"reason":"sensei-mệt-lo-lắng"}</arona_feelings>',
      "",
