...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("shittimchest-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("shittimchest-cache-test1-");
    const workspace2 = await makeTempWorkspace("shittimchest-cache-test2-");
