...
export const DEFAULT_SANDBOX_IMAGE = "shittimchest-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "shittimchest-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "shittimchest-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "shittimchest-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "shittimchest-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "shittimchest-sandbox-browser";
