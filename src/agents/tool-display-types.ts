/**
 * Shared types and low-level utility functions for tool display rendering.
 *
 * This module is the foundation layer — no imports from sibling tool-display modules.
 */
