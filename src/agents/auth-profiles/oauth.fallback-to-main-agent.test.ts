...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveShittimChestAgentDir() returns mainAgentDir
    process.env.SHITTIMCHEST_STATE_DIR = tmpDir;
    process.env.SHITTIMCHEST_AGENT_DIR = mainAgentDir;
