/**
 * Resolve human-readable detail strings for specific tool categories:
 * read, write, web-search, web-fetch.
 */

import { asRecord, resolvePathArg } from "./tool-display-types.js";
