...
const CLEANUP_STATE_KEY = Symbol.for("shittimchest.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("shittimchest.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("shittimchest.sessionWriteLockWatchdogState");
