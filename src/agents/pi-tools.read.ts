...
type ShittimChestReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: ShittimChestReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createShittimChestReadTool(base, {
...
export function createShittimChestReadTool(
  base: AnyAgentTool,
  options?: ShittimChestReadToolOptions,
): AnyAgentTool {
