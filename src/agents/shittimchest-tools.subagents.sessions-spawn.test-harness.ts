...
export type CreateShittimChestToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateShittimChestToolsOpts) {
