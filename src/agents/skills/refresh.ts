...
function resolveWatchPaths(workspaceDir: string, config?: ShittimChestConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ShittimChestConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ShittimChestConfig }) {
