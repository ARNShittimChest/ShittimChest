...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): ShittimChestConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: ShittimChestConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: ShittimChestConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
