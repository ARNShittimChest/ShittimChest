...
type WebSearchConfig = NonNullable<ShittimChestConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: ShittimChestConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("shittimchest configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.shittimchest.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://shittimchest.ai",
          "X-Title": "ShittimChest Web Search",
        },
