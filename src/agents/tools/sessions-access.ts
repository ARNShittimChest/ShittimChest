...
export function resolveSessionToolsVisibility(cfg: ShittimChestConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: ShittimChestConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: ShittimChestConfig): AgentToAgentPolicy {
