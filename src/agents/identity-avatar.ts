...
function resolveAvatarSource(cfg: ShittimChestConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ShittimChestConfig, agentId: string): AgentAvatarResolution {
