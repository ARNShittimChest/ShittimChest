...
export function applyOpencodeZenProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyOpencodeZenConfig(cfg: ShittimChestConfig): ShittimChestConfig {
