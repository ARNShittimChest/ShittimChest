...
export function applyLitellmProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyLitellmConfig(cfg: ShittimChestConfig): ShittimChestConfig {
