...
export function applyVercelAiGatewayProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyVercelAiGatewayConfig(cfg: ShittimChestConfig): ShittimChestConfig {
