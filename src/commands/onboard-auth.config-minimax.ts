...
export function applyMinimaxProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyMinimaxConfig(cfg: ShittimChestConfig): ShittimChestConfig {
