...
function resolveDefaultAccountId(cfg: ShittimChestConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ShittimChestConfig): boolean {
...
export function summarizeBindings(cfg: ShittimChestConfig, bindings: AgentBinding[]): string[] {
