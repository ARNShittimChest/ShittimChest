...
const ensureShittimChestModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveShittimChestAgentDir = vi.fn().mockReturnValue("/tmp/shittimchest-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/shittimchest-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureShittimChestModelsJson,
}));
