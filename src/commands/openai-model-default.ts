...
export function applyOpenAIProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyOpenAIConfig(cfg: ShittimChestConfig): ShittimChestConfig {
