...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.shittimchest.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("shittimchest hooks list")}`,
      `  ${formatCliCommand("shittimchest hooks enable <name>")}`,
      `  ${formatCliCommand("shittimchest hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
