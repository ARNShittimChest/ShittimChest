...
export function applyOpenrouterProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyMoonshotConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ShittimChestConfig): ShittimChestConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: ShittimChestConfig): ShittimChestConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: ShittimChestConfig): ShittimChestConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyQianfanProviderConfig(cfg: ShittimChestConfig): ShittimChestConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: ShittimChestConfig): ShittimChestConfig {
