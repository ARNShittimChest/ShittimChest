...
function resolveMentionPatterns(cfg: ShittimChestConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ShittimChestConfig | undefined, agentId?: string): RegExp[] {
