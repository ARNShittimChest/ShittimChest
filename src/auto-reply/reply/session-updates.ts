...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: ShittimChestConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: ShittimChestConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.SHITTIMCHEST_TEST_FAST === "1") {
