...
describe("stageSandboxMedia", () => {
  it("stages allowed media and blocks unsafe paths", async () => {
    await withSandboxMediaTempHome("shittimchest-triggers-", async (home) => {
      const cfg = createSandboxMediaStageConfig(home);
      const workspaceDir = join(home, "shittimchest");
      ...
      {
        const inboundDir = join(home, ".shittimchest", "media", "inbound");
