...
export function isCommandEnabled(cfg: ShittimChestConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: ShittimChestConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: ShittimChestConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: ShittimChestConfig) {
