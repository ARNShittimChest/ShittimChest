...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: ShittimChestConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: ShittimChestConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__shittimchestMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__shittimchestMcporterColdStartWarned;
  });
