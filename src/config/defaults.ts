...
export function applyMessageDefaults(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyTalkApiKey(config: ShittimChestConfig): ShittimChestConfig {
...
export function applyTalkConfigNormalization(config: ShittimChestConfig): ShittimChestConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: ShittimChestConfig): ShittimChestConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyLoggingDefaults(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyContextPruningDefaults(cfg: ShittimChestConfig): ShittimChestConfig {
...
export function applyCompactionDefaults(cfg: ShittimChestConfig): ShittimChestConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
