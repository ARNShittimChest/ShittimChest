...
export const normalizePluginsConfig = (
  config?: ShittimChestConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: ShittimChestConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: ShittimChestConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: ShittimChestConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
