...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @shittimchest/voice-call -> voice-call).
...
export function discoverShittimChestPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".shittimchest", "extensions")];
