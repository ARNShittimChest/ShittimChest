...
export type ShittimChestPluginConfigSchema = {
...
export type ShittimChestPluginToolContext = {
...
export type ShittimChestPluginToolFactory = (
  ctx: ShittimChestPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type ShittimChestPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type ShittimChestPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<ShittimChestConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type ShittimChestPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current ShittimChest configuration */
  config: ShittimChestConfig;
 ...
 */
export type ShittimChestPluginCommandDefinition = {
...
export type ShittimChestPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type ShittimChestPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type ShittimChestPluginCliContext = {
  program: Command;
  config: ShittimChestConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type ShittimChestPluginService = {
  id: string;
  start: (ctx: ShittimChestPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: ShittimChestPluginServiceContext) => void | Promise<void>;
};

export type ShittimChestPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type ShittimChestPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: ShittimChestPluginConfigSchema;
  register?: (api: ShittimChestPluginApi) => void | Promise<void>;
  activate?: (api: ShittimChestPluginApi) => void | Promise<void>;
};

export type ShittimChestPluginModule =
  | ShittimChestPluginDefinition
  | ((api: ShittimChestPluginApi) => void | Promise<void>);

export type ShittimChestPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | ShittimChestPluginToolFactory,
    opts?: ShittimChestPluginToolOptions,
  ) => void;
  registerHook: (
  ...
  registerService: (service: ShittimChestPluginService) => void;
   ...
   */
  registerCommand: (command: ShittimChestPluginCommandDefinition) => void;
