...
export const PLUGIN_MANIFEST_FILENAME = "shittimchest.plugin.json";
...
// package.json "shittimchest" metadata (used for onboarding/catalog)
...
export type ShittimChestPackageManifest = {
  extensions?: string[];
...
): ShittimChestPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
