...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/shittimchest/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/shittimchest/extensions",
        global: "/Users/x/.shittimchest/extensions",
        workspace: "/Users/x/ws/.shittimchest/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.shittimchest/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/shittimchest/extensions",
        global: "/Users/x/.shittimchest/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.shittimchest/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/shittimchest/extensions",
        global: "/Users/x/.shittimchest/extensions",
