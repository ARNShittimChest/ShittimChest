...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.shittimchest.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", SHITTIMCHEST_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.shittimchest.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.shittimchest.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when SHITTIMCHEST_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.shittimchest.gateway.plist",
    },
    {
      name: "uses profile-specific label when SHITTIMCHEST_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", SHITTIMCHEST_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.shittimchest.jbphoenix.plist",
    },
    {
      name: "prefers SHITTIMCHEST_LAUNCHD_LABEL over SHITTIMCHEST_PROFILE",
      env: {
        HOME: "/Users/test",
        SHITTIMCHEST_PROFILE: "jbphoenix",
        SHITTIMCHEST_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from SHITTIMCHEST_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        SHITTIMCHEST_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty SHITTIMCHEST_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        SHITTIMCHEST_PROFILE: "myprofile",
        SHITTIMCHEST_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.shittimchest.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
