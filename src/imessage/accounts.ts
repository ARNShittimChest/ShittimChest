...
function mergeIMessageAccountConfig(cfg: ShittimChestConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: ShittimChestConfig): ResolvedIMessageAccount[] {
