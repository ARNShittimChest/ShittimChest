...
function baseCfg(): ShittimChestConfig {
  return {
    channels: {
      imessage: {
        dmPolicy: "open",
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550001111",
        is_from_me: false,
        text: "@shittimchest hello",
        is_group: true,
      },
      opts: {},
      messageText: "@shittimchest hello",
      bodyText: "@shittimchest hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@shittimchest hi",
        is_group: true,
      },
      opts: {},
      messageText: "@shittimchest hi",
      bodyText: "@shittimchest hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@shittimchest ok",
        is_group: true,
      },
      opts: {},
      messageText: "@shittimchest ok",
      bodyText: "@shittimchest ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",
