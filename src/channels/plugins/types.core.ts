...
export type ChannelAgentToolFactory = (params: { cfg?: ShittimChestConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ShittimChestConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ShittimChestConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ShittimChestConfig }) => boolean;
  supportsCards?: (params: { cfg: ShittimChestConfig }) => boolean;
