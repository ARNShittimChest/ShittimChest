...
function makeCfg(overrides?: Partial<ShittimChestConfig>): ShittimChestConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
describe("resolveWhatsAppHeartbeatRecipients", () => {
  ...
  function resolveWith(
    cfgOverrides: Partial<ShittimChestConfig> = {},
  ...
  it("ignores session store when session scope is global", () => {
    ...
    const result = resolveWith({
      session: { scope: "global" } as ShittimChestConfig["session"],
