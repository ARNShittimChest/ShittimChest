...
export function listChannelMessageActions(cfg: ShittimChestConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: ShittimChestConfig): boolean {
...
export function supportsChannelMessageCards(cfg: ShittimChestConfig): boolean {
