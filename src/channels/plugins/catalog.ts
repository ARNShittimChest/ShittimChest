...
import { discoverShittimChestPlugins } from "../../plugins/discovery.js";
import type { ShittimChestPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ShittimChestPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["SHITTIMCHEST_PLUGIN_CATALOG_PATHS", "SHITTIMCHEST_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ShittimChestPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ShittimChestPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ShittimChestPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverShittimChestPlugins({ workspaceDir: options.workspaceDir });
