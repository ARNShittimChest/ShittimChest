...
export function isAcpEnabledByPolicy(cfg: ShittimChestConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: ShittimChestConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: ShittimChestConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: ShittimChestConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: ShittimChestConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: ShittimChestConfig, agentId: string): boolean {
