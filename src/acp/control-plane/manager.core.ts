...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: ShittimChestConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: ShittimChestConfig): AcpManagerObservabilitySnapshot {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: ShittimChestConfig }): Promise<void> {
