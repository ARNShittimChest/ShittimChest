...
export function listBindings(cfg: ShittimChestConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: ShittimChestConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ShittimChestConfig) {
