...
import { type ShittimChestConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ShittimChestConfig): string[] {
...
export function listAgentsForGateway(cfg: ShittimChestConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ShittimChestConfig): string {
...
function resolveSessionStoreAgentId(cfg: ShittimChestConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ShittimChestConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ShittimChestConfig): GatewaySessionsDefaults {
