...
import {
  probeAuthenticatedShittimChestRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated shittimchest relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedShittimChestRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-shittimchest-relay-token",
