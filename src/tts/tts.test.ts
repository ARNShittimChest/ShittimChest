...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.SHITTIMCHEST_TTS_PREFS;
      process.env.SHITTIMCHEST_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.SHITTIMCHEST_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: ShittimChestConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
