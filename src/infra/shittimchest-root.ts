...
const CORE_PACKAGE_NAMES = new Set(["shittimchest"]);
...
export async function resolveShittimChestPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveShittimChestPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
