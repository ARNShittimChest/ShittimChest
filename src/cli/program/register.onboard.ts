...
export function registerOnboardCommand(program: Command) {
  const command = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.shittimchest.ai/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.shittimchest/workspace)")
    .option(
      "--reset",
  ...
  command
    ...
    .option("--cli", "Use terminal UI instead of web browser", false);
