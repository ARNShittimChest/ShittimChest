    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["shittimchest channels list", "List configured channels and auth profiles."],
          ["shittimchest channels status --probe", "Run channel status checks and probes."],
          [
            "shittimchest channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["shittimchest channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.shittimchest.ai/cli/channels",
        )}\n`,
    );
