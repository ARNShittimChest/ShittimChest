      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["shittimchest gateway run", "Run the gateway in the foreground."],
            ["shittimchest gateway status", "Show service status and probe reachability."],
            ["shittimchest gateway discover", "Find local and wide-area gateway beacons."],
            ["shittimchest gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.shittimchest.ai/cli/gateway")}\n`,
      ),
  );
