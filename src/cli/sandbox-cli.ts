...
const SANDBOX_EXAMPLES = {
  main: [
    ["shittimchest sandbox list", "List all sandbox containers."],
    ...
    ["shittimchest sandbox recreate --agent mybot", "Recreate agent containers."],
    ["shittimchest sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["shittimchest sandbox list", "List all sandbox containers."],
    ["shittimchest sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["shittimchest sandbox explain", "Show effective sandbox config."],
    ["shittimchest sandbox explain --session agent:main:main", "Explain a specific session."],
    ["shittimchest sandbox explain --agent work", "Explain an agent sandbox."],
    ["shittimchest sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.shittimchest.ai/cli/sandbox")}\n`,
    )
    .action(() => {
