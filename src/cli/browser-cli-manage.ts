...
async function runBrowserToggle(
  ...
  const name = status.profile ?? "shittimchest";
...
export function registerBrowserManageCommands(
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        defaultRuntime.log(
          [
            `profile: ${status.profile ?? "shittimchest"}`,
  ...
  browser
    ...
    .option("--driver <driver>", "Profile driver (shittimchest|extension). Default: shittimchest")
    .action(
