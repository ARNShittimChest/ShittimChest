...
export function listWhatsAppAuthDirs(cfg: ShittimChestConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ShittimChestConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: ShittimChestConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ShittimChestConfig): ResolvedWhatsAppAccount[] {
