...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "shittimchest-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as ShittimChestApp);
      void loadAgents(host as unknown as ShittimChestApp);
      void loadToolsCatalog(host as unknown as ShittimChestApp);
      void loadNodes(host as unknown as ShittimChestApp, { quiet: true });
      void loadDevices(host as unknown as ShittimChestApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as ShittimChestApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as ShittimChestApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as ShittimChestApp);
  }
}
